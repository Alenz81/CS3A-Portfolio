...
void PokerAnalysis::drawAnalysis(sf::RenderWindow &window) {
    std::vector<ComponentOne*> components;
...
bool PokerAnalysis::isRun1() const {
    return isRun;
}

void PokerAnalysis::setIsRun(bool isRun) {
    PokerAnalysis::isRun = isRun;
}
